...
"thumbnailUrl": 'https://telegra.ph/file/23e7554efacaa0eb48d68.jp', 
"thumbnail": kalimage
}}}
//=================================================//
const doc = { 
...
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Zykuanじくあん ${ngazap(prefix)}`,"body": `HW MODS WA ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: doc })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Zykuanじくあん`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: hw })
} 
...
let user = global.db.data.users[m.sender]
anjay(`
Hello Saya Bot Zykuanじくあん${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `HW MODS WA ${ngazap(prefix)}.BIN`, title: `Zykuanじくあん ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: { url: 'https://postimg.cc/345yGBjZ' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6282133532380 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : ga ada\n⭔ Saweria : https://saweria.co/Zykuan` }, { quoted: hw })
}
break
//=================================================//
case 'sc': {
